...
`voucherInfo \ addCredits` <br />Information relating to an AddCredits offer type| <span class="array">array[objects]</span> | 
...
`voucherInfo \ lowStart` <br />Information relating to an LowStart offer type| <span class="array">array[objects]</span> | 
...
`voucherInfo \ percentageDiscount` <br />Information relating to an PercentageDiscount offer type| <span class="array">array[objects]</span> | 
...
`voucherInfo \ freePeriod` <br />Information relating to an freePeriod offer type| <span class="array">array[objects]</span> | 
...
`voucherInfo \ groupDiscount` <br />Information relating to an GroupDiscount offer type| <span class="array">array[objects]</span> | 
...
`voucherInfo \ fixedPriceDiscount` <br />Information relating to an FixedPriceDiscount offer type| <span class="array">array[objects]</span> | 
