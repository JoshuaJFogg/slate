...
```shell
curl --request POST \
  --url https://uat.mppglobal.com/api/accounts/{accountReference}/addresses \
...
```csharp
var client = new RestClient("https://uat.mppglobal.com/api/accounts/{accountReference}/addresses");
...
```java
HttpResponse<String> response = Unirest.post("https://uat.mppglobal.com/api/accounts/{accountReference}/addresses")
  .header("x-clientId", "1001")
  .header("x-clientPassword", "Str0ngP@ssword")
  .header("x-version", "10.0.0")
  .header("content-type", "application/json")
...
url = URI("https://uat.mppglobal.com/api/accounts/{accountReference}/addresses")
...
conn.request("POST", "/api/accounts/{accountReference}/addresses", payload, headers)
...
<span class="endpoint-path">https://uat.mppglobal.com/api/accounts/{accountReference}/addresses</span>
</div>
...
```java
HttpResponse<String> response = Unirest.get("https://uat.mppglobal.com/api/accounts/{accountReference}/addresses")
  .header("x-clientId", "1001")
  .header("x-clientPassword", "Str0ngP@ssword")
  .header("x-version", "10.0.0")
  .body("{}")
...
conn.request("GET", "/api/accounts/{accountReference}/addresses", payload, headers)
...
```json
[{
    "addressIdentifier": "0010D4LJH97VWQMF12",
    "houseName": "HouseName",
...
```shell
curl --request GET \
  --url https://uat.mppglobal.com/api/accounts/{accountReference}/addresses/{addressReference} \
  --header 'x-clientId: 1001' \
  --header 'x-clientPassword: Str0ngP@ssword' \
  --header 'x-version: 10.0.0' \
  --data '{}'
...
```csharp
var client = new RestClient("https://uat.mppglobal.com/api/accounts/{accountReference}/addresses/{addressReference}");
var request = new RestRequest(Method.GET);
request.AddHeader("x-version", "10.0.0");
request.AddHeader("x-clientId", "1001");
request.AddHeader("x-clientPassword", "Str0ngP@ssword");
...
```java
HttpResponse<String> response = Unirest.get("https://uat.mppglobal.com/api/accounts/{accountReference}/addresses/{addressReference}")
  .header("x-clientId", "1001")
  .header("x-clientPassword", "Str0ngP@ssword")
  .header("x-version", "10.0.0")
  .body("{}")
...
url = URI("https://uat.mppglobal.com/api/accounts/{accountReference}/addresses/{addressReference}")
...
conn.request("GET", "/api/accounts/{accountReference}/addresses/{addressReference}", payload, headers)
