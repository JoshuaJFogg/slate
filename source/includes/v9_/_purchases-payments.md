...
`paymentMethod` <br />The type of payment method the account has selected. `CreditCard`, `PayPal`, `ServiceCredits`, `Alipay`, `SPCarrierBilling` and `Offline`.| <span class="string">string</span> |  |
